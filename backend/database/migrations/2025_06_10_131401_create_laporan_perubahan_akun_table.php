...
class CreateLaporanPerubahanAkunTable extends Migration
{
    public function up(): void
    {
        Schema::create('laporan_perubahan_akun', function (Blueprint $table) {
            $table->uuid('laporan_perubahan_akun_id');
