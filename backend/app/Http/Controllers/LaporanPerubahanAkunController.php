...
use App\Models\LaporanPerubahanAkun;
use App\Models\DaftarSiswa;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Validator;

class LaporanPerubahanAkunController extends Controller
{
 ...
 public function store(Request $request)
    {
        ...
        try {
            $laporan = DB::transaction(function () use ($request) {
                ...
                return LaporanPerubahanAkun::create([
    ...
    {
        try {
            $laporan = LaporanPerubahanAkun::with('siswa:daftar_siswa_id,nama,kelas,no_absen')
